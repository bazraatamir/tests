...
import logo from '../assets/photo_6249040041607282879_x.jpg'
const Header = () => {
        ...
        <header id='header '>
            <nav className='flex flex-wrap py-12 justify-between items-center px-6 xs:px-12 z-30 relative max-w-screen-2xl mx-auto
                ...
                <h1 className='flex flex-col justify-start'>
                    <a href='#' className='text-4xl font-bold text-heading-color font-noto-serif hover:text-heading-color/80'><img className='w-[200px]' src={logo} alt="" /></a>
                </h1>
                ...
                <div className={`w-full ${togglerState===false ? 'hidden' : 'flex'} lg:flex justify-end pt-6 my border-r border-black animate-slideDown
                    ...
                    <ul className={`list-none flex flex-col items-end font-medium text-lg pr-6
                        ...
                        <li className='block'>
                            <a href='#' className='hover:text-p-color'>Нүүр</a>
                        </li>
                        <li className='block'>
                            <a href='#about' className='hover:text-p-color'>Бидний тухай</a>
                        </li>
                        <li className='block'>
                            <a href='#products' className='hover:text-p-color'>Бүтээгдэхүүн</a>
                        </li>
                        <li className='block'>
                            <a href='#contacts' className='hover:text-p-color'>Холбоо барих</a>
                        </li>
