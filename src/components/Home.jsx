...
const Home = () => {
    ...
    <section id='home' className='flex items-center justify-center mb-24'>
        ...
        <div className='absolute mx-20 xs:mx-10 mb-[14rem] p-8 xs:mb-[24rem] sm:mb-[30rem] xs:mr-0 lg:mb-0 lg:mr-[32rem] xlg:mr-[40rem] xl:mr-[48rem] 2xl:mr-[64rem] flex items-start flex-col space-y-6 md:p-12 backdrop-blur-xl rounded-sm bg-white/30 '>
            {/* <img src={DotsImg} className='absolute scale-90 rotate-90 
                                        mr-[26rem] mb-28
                                        sm:mr-[32rem] sm:mb-24
                                        lg:mb-[26rem] lg:mr-44 lg:scale-100'/> */}
            <h1 className='font-bold text-2xl xs:text-3xl sm:text-4xl leading-tight sm:leading-tight text-heading-color'>
            Бид танд<br/>
            орчин үеийн интерьерийг бүтээхэд тусална<br/>
         
            </h1>
            <p className='text-p-color font-normal text-base xs:text-lg sm:text-xl'>
            Бид танд мэргэжлийн интерьер дизайнаар<br/>
            тансаг оёмсог интерьерийг бүтээхэд<br/>
            туслах болно.<br/>
            </p>
        </div>
        <div className='place-self-center my-auto max-w-[800px] mt-44 sm:mt-64 lg:mt-0
                        h-[500px]
                        sm:max-w-screen-sm 
                        md:max-w-[800px]  
                        xlmax-w-screen-2xl'>
            <img src={HeaderImage} className=' w-[800px] h-[100%] rounded-md object-cover '/>
        </div>
        </div>
