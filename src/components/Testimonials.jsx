        ...
        <section className='flex justify-center items-center mb-24'>
            <div className='bg-secondary-gray md:px-24 mx-12 px-12 py-12 flex flex-col justify-center items-center relative overflow-hidden rounded-2xl'>
                ...
                <div className='flex flex-col justify-center items-center mb-6'>
                    <h1 className='text-heading-color text-5xl leading-tight text-center font-bold mb-6'>Харилцагчидын <br /> сэтгэгдэл </h1>
                    <p className='text-[#3A4F65] text-lg font-medium text-center'>Файлын хадгалалт хялбар болсон  – бусад газарт олох боломжгүй <br /> хүчирхэг функцүүдийг агуулсан. Хэрэв та.</p>
                </div>
                <div className='flex flex-col lg:flex-row justify-center items-center lg:my-12'>
                    ...
                    <div className='flex flex-col justify-center items-start space-y-6 lg:space-y-12'>
                        ...
                        <p className='text-2xl text-[#5E7388] font-medium italic'>“Файлын хадгалалт хялбар болсон <br /> бусад газарт олох боломжгүй <br /> хүчирхэг функцүүдийг агуулсан. Хэрэв та”</p>
                        <div>
